...
def build_professional_pptx(
    *,
    ...
    def add_footer(slide, slide_no: int):
        ...
        add_text(slide, "AgentInvest", margin, footer_y, Inches(2.2), Inches(0.25), size=8, color=muted_gray)
        add_text(
            slide,
    ...
    def render_title_slide():
        ...
        add_text(slide, "AGENTINVEST", margin, Inches(0.35), Inches(2.0), Inches(0.25), size=9, color=accent_blue, bold=True)
        add_text(
            slide,
        ...
        add_text(
            slide,
            deck_spec.get("subtitle") or f"{ticker} | Generated by AgentInvest",
            margin,
            Inches(3.0),
            Inches(7.8),
            Inches(0.45),
